...
// This module helps us deal with volitile memory. It will help us deal with Rust memory protection.
...
// Extend functionality by making a rust Formatting Macro.
use core::fmt;
...
#[macro_export]
macro_rules! print {
    ($($arg:tt)*) => ($crate::kernel::vga_driver::_print(format_args!($($arg)*)));
}
